...
def refine_thai_captions_with_llm(
    ...
    if is_chunked:
        ...
        prompt = (
            ...
            "6. การแบ่งท่อนอย่างมืออาชีพ: ประโยคต้องมีความหมายสมบูรณ์ในตัวเอง ห้ามนำคำเปิดประโยคใหม่หรือกริยาแอ็กชัน (เช่น 'เชิญชวน', 'แนะนำ', 'สนใจ') มาห้อยท้ายประโยคเดิมเด็ดขาด\n\n"
